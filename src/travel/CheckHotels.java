...
public class CheckHotels extends JFrame implements Runnable
{
    ...
    CheckHotels()
    {
        ...
        for(int i = 0; i <= 9 ;i++)
        {
            icons[i] = new ImageIcon(ClassLoader.getSystemResource("icons/hotel"+(i+1)+".jpg"));
    ...
    public void run()
    {
        String[] text = new String[] {"Bella Vista Villa","Venetian Serenity Lodge","Dolce Dwell","Villa Verona","Riviera Retreat","Siena Suites","Paradiso Palazzo","Sicilian Sun","Serenità Solare","Luna Lusso"} ;
        try {
            for (int i = 0; i <= 9 ;i++)
            {
